...
const String FIREBASE_HOST  = "https://ltha-6175c-default-rtdb.firebaseio.com/";
const String FIREBASE_SECRET  = "ScdrIkxjX6AcRY3jTQcSXDVYU2tNRX7xivZHubIy";
...
String get_temprature()
{
  ...
  String h = latitude;
  String t = longitude;
  String link = "https://www.google.com/maps/search/?api=1&query="+h+","+t;
 // String lik=co

  // Check if any reads failed and exit early (to try again).
  if (h == "" || t == "") {
    Serial.println(F("Failed to read from GPS data!"));
    goto topFn;
  }
